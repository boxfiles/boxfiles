---
name: e2e-testing-cli-with-bats
description: Use when writing shell-native end-to-end tests for CLI apps with Bats, especially when exit codes, stdout/stderr, filesystem effects, and isolated HOME/config state must be verified through real command invocation.
---

# Testing CLI E2E with Bats
